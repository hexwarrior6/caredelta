...
ACTION_MATRIX={
 ...
 Action.CREATE_HIGHLIGHT:frozenset({UserRole.CLINICIAN,UserRole.ADMIN}), Action.ACCEPT_HIGHLIGHT:frozenset({UserRole.CLINICIAN,UserRole.ADMIN}), Action.REJECT_HIGHLIGHT:frozenset({UserRole.CLINICIAN,UserRole.ADMIN}), Action.PIN_HIGHLIGHT:frozenset({UserRole.CLINICIAN,UserRole.ADMIN}),
 Action.ROLLBACK_ENTRY:care_team, Action.READ_AUDIT_LOG:frozenset({UserRole.CLINICIAN,UserRole.ADMIN}), Action.INGEST_AI_NOTE:frozenset({UserRole.PATIENT,UserRole.STAFF,UserRole.CLINICIAN,UserRole.ADMIN}),
 Action.PATIENT_AI_CHAT:frozenset({UserRole.PATIENT}),
 Action.TRANSCRIBE_AUDIO:frozenset(UserRole),
}
